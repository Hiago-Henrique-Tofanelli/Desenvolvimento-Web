...
//enquando houver registros (linhas)
// a serem recuperadas
while(!feof($arquivo)) { //testa pelo fim de um arquivo
  //linhas
  /* feof verifica se o arquivo terminou, 
  retornando true só no final do arquivo.
  Para utilizar no while temos que iniciar 
  com true, por isso !feof */

  $registro = fgets($arquivo);
  /* já a função fgets pega o que tem em 
  cada uma das linhas */
            ...
            <div class="card-body">
              <?php foreach($chamados as $chamado){ ?>
                <?php
                    ...
                    /* explode faz uma string virar array 
